...
public class ADrawerLayout extends ViewGroup {
	...
	protected static int DIMMER_VIEW_ID = 0x78787878;

    protected View addContentDimmer () {
    ...
    protected DrawerState mDrawerState = new DrawerState();
    ...
    protected float getScrollFraction() {
